...
public class Circle {
	...
	{								//IDEE: Distanz zwischen aktuellem Punkt und *point* darf nicht größer als der Radius sein.
		...
		if(this.getRadius() <= this.getLocation().getDistance(point))
			return true;
	...
	public static Circle fromPoints(Point center, Point p) 
	{
		...
		circle.setRadius(center.getDistance(p)); /*Wenn *radius von circle* = *Distanz von p* (zum aktuellen Punkt *center*), 
