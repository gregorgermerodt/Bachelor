...
public class Measurement {
	...
	public int[] getValuesAboveThreshold(int threshold) {
		...
		for (int i=0;i< arrayloesung.length;i++)  ////'i' wird f¸r die Stellen im arrayloesung gebraucht, wo wir was abspeichern wollen
		{
			while(counter2 < data.length)  ////solange wir uns im data array befinden (also Zahl ist < als Zahl f¸r die Grˆﬂe des data Arrays)...
			{
				...
				{
					arrayloesung[i] = data[counter2];  //...Dann speicher die Zahl in unserem Lˆsungs Array an der jeweiligen Stelle ab
