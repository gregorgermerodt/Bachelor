...
public class Matrix {
	...
	public void transpose() {
		int [] [] transponierte = new int [values[0].length][values.length];
		for (int i = 0; i < transponierte.length; i++){
			for (int j = 0; j < transponierte[0].length; j++){
				transponierte [i] [j] = values [j] [i];
			}
		}
		values = transponierte;
	}
