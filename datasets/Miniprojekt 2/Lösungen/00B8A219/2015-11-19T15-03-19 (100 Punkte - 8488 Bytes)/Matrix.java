...
for (int row=0;row<values.length; row++){
	...
	public int[] getColumnVector(int col) { //col=nr.derSpalte)
		int []spalte=new int [values.length];//Höhe der Matrix=values.length
...
for(int indexSpalte=0;indexSpalte<values.length;indexSpalte++){
	...
	for(int indexZeile=0; indexZeile<values[indexSpalte].length;indexZeile++){
