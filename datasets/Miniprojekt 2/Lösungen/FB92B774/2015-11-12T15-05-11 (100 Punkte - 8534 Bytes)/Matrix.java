...
/**2f)*/	
	public void transpose()  //getcolumnVector() an dieser Stelle nutzen.
	{
		int[][] transe = new int[getColumnLength()][getRowLength()]; //ZielArray muss 2D sein, aber mit vertauschten Zeilen und Spalten.
		for(int i = 0; i < getColumnLength(); i++)	
		{
			transe[i] = getColumnVector(i);
		}
		values = transe; //FINAL: ZUWEISUNG NICHT VERGESSEN!!!
	}
