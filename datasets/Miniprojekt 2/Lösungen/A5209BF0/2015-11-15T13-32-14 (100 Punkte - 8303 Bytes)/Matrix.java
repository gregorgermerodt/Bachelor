...
public class Matrix {
	...
	public Matrix(int[][] initialValues) {//1a
		values = initialValues; //values und initialValues zeigen auf die gleiche Matrix

	}

	public void scalarMultiplication(int c) {//1b
	...
	public void add(Matrix m) { //1c
		for(int row = 0; row < values.length; row++){
			for (int column = 0; column < values[row].length ; column++){ //wie oben
	...
	public int[] getColumnVector(int col) { //1d
	...
	public boolean isEqualTo(Matrix m) { //1e
