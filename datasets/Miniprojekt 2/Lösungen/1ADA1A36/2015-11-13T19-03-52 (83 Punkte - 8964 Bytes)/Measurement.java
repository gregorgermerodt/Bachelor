...
public class Measurement 
{
	...
	{
		int[] tempdata; //Array Laenge nicht einfach vergroessern deshalb neues Array
		...
		data=tempdata; // data soll neu erzeugt werden
		*/
	...
	public void addValues(int[] values) 
	{
		...
		/* irgendwas stimmt nicht 
		  ...
		  tempdata[i]=values[i];
		  		...
		  		{
		  		tempdata[j]=values[j-data.length];
		  		}
		  data= tempdata;
		 */
	}
	...
	{		
		 ...
		 * 
		 * for(int i= 0; int j=0; j< neu.length; i++)
		 * {
		 * 		if(data[j]> threshold)
		 * 		{
		 * 		data[j]=data[i];
