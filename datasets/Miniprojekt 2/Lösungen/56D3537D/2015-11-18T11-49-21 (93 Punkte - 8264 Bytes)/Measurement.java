...
public class Measurement {
	...
	private int[] data; // Array erstellt vom Typ int
	...
	public void addValue(int value) {
		int[] data2 = new int[data.length + 1]; //neues array erzeugen data2 - eins länger als das alte
		for( int index = 0 ; index < data.length ; index++ ){
			data2[index] = data[index]; //array stück für stück importiert
		}
		// hinzufügen der neuen letzten Zahl zum neuen Array
		data2[data2.length - 1] = value; 
		//Setzen der Referenz vom Data Array auf das Data2 Array
		data = data2; 
	}
