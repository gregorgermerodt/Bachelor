...
public class Measurement {
	...
	//und soll diese als neue Messwerte an das Ende des data-Arrays setzen. Erzeugen Sie auch hier ein neues, vergrößertes Array
	public void addValues(int[] values) {
		...
		for (int index = data.length; index< data.length+values.length;index++){
			...
			data = neu;
			// gibt Fehlermeldung "Exception in thread "main" ArrayIndexOutOfBoundsException :  -10 " 
