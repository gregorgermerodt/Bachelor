...
public class Matrix {
	...
	this.values = initialValues;  // ich glaube das geht bei Arrays nicht
	...
	values[i][j] = values[i][j] * c; //geht die Multiplikation so vom Array?	
	...
	int [][] transpose = new int[values[0].length][values.length]; // einen Speicher erstellen
