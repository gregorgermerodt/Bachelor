...
public class Measurement {
	...
	data = new int[0]; //neues Array mit der Länge 0
	...
	int min = data[0];		// als erster wird irgendein Minimum wert zugeordnet
	for(int i=0 ; i<data.length ; i++) {    // Die Schleife durchläuft das Array data
	if(data[i] < min)		// hier wird geprüft, ob der aktuelle Wert kleiner als der min wert ist
	min = data[i];				// wenn ja, wird der zugeordnet
	}
	return min;
