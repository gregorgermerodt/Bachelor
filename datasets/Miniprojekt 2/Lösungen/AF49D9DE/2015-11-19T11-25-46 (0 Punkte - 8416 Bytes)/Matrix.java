...
public class Matrix {
	...
	public void transpose() {
		...
		int[][]transponiertesArray;
		transponiertesArray = new int[this.values[0].length][this.values.length];
		...
		for(int i=0; i<this.values[0].length; i++) {
			...
			for(int j=0; j<this.values.length; j++){
				...
				transponiertesArray[i][j] = this.values[j][i];
				
			}
			
		}
		
		this.values = transponiertesArray;
