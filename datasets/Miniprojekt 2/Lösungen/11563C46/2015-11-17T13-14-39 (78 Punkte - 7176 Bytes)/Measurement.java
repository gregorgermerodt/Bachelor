...
public class Measurement {
	...
	public Measurement() {
		data = new int[0];//array hat länge 0

	}

	public void addValue(int value) {
		int[] neu = new int[data.length+1]; //hier wird neues array angelegt, array mit der länge 1
		for(int index = 0; index < data.length; index++ ){
			neu[index] = data[index];	
		}
		neu[neu.length - 1] = value; //neu array mit 1 element mehr	
		data = neu; // data array soll ausgegeben werden, deswegen 
	}
