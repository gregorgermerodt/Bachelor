...
public class Measurement {
	...
	public void addValues(int[] values) {
		// Erzeugen eines neuen Hilfsarrays mit der Länge des bereits existierenden Arrays
	...
	public int getMinimumValue() {
		...
		//int minimum = data[0]; ginge auch, weil ist garantiert nicht kleiner als der kleinste Wert des Arrays
