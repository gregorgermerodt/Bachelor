...
public class Matrix {
	...
	public void scalarMultiplication(int c) {
		// Multipliziere jedes Element mit c
		// i = Reihe;   j = Spalte;   values.length = Anzahl der Reihen
		for(int i= 0; i<values.length; i++)
		{
			for(int j=0; j<values[i].length; j++)
			{
				// columns = spalten c = übergabewert aus dem Hauptprogramm
	...
	public void transpose() {
		...
		int[][] zw = new int[values.length][values[0].length];
		 ...
		 values = new int[zw[0].length][zw.length];
