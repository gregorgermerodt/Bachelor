...
public class Matrix {
	...
	public void add(Matrix m) {
		//Matrix m wird in values gespeichert
		for(int i = 0; i < values.length; i++){
			for(int j = 0; j < values[i].length; j++){
	...
	public int[] getColumnVector(int col) {
		// col ist die Spaltenindex(bsp. 1)
		int[] spalte = new int[values.length];
		//zweite for-Schleife ist nicht notwendig, da Spaltenindex col ändert sich nicht
		for (int i = 0; i < values.length; i++) {
	...
	public void transpose() {
		//values[0] heißt wir fangen an der obersten Zeile
