...
public class Measurement {
	...
	private int[] data;//Klassenvariablen
	...
	public void addValue(int value) {
		// create away with one more space to save the added value
		...
		data = neu;
			...
			//index < data.length endet die schleife 
			//index++ to continue the next arrays
