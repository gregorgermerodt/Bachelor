...
public class Measurement {
	...
	public void addValue(int value) { // Parameter als Rückgabewert...in den Klammern steht immer, was man als Rückgabe erwarten
		                               // man guckt erst, dass man das Gerüst des Arrays neu macht, dann den Inhalt des alten ins neue kopiert
	...
	{ array[i] = data [i]; }  // das neue muss in das alte Array kopiert werden 
	
	array[data.length]= value;    // array an der Stelle data.length wird Wert Value hinzugefügt 
	array = data;                // ich mache ein neues Array und weise dieses dem alten hinzu ? 
	...
	public void addValues(int[] values) {
		...
		// addValue(values[i]); so könnte man es theoretisch auch machen 	
	...
	{        
	if ( data[i] < min) {  // er geht jedes Element durch & wenn er an der stelle ist, wo dann der kleinste Wert ist, speichert er ihn 
		min = data[i];
	}
	...
	public int[] getValuesAboveThreshold(int threshold) { // man macht das nicht für eine 
