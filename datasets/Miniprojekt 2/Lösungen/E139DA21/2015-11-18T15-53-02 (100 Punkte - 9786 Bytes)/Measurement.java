...
public class Measurement {
	...
	public void addValue(int value) { 
		//�BUNG ERGEBNIS: RICHTIG, NICHT MEHR BEARBEITEN!
	...
	public void addValues(int[] values) {
		//�BUNG - RICHTIG - NICHT MEHR BEARBEITEN
		int[] neu = new int[data.length+values.length];
		//For atmasolja az ertekeket az egyikbol a masikba!!
		for(int index=0;index<data.length;index++){
			neu[index]=data[index];			
		}
	...
	public int[] getValuesAboveThreshold(int threshold) {
		// int[] temp = new int[data.lenght]
		//int zaehler = 0;
		//for (in index = 0; index < data.lenght; index++)
		//{
