...
public class Measurement {
	...
	public Measurement() {
	this.data = new int [0]; // Konstruktor mit Array Länge von 0
	}

	public void addValue(int value) {
		int [] vergroesserterArray = new int [data.length+1];  //array welches genau eine zahl größer ist
	...
	public void addValues(int[] values) {
		...
		//länge
		int speicher = 0; //speicher für index 
		for(int index = 0; index<data.length;index++){ //kopiervorgang
			biggerArray[index] = data[index];
			speicher = index+1; //speichert aktuellen index um eins erhöht zur weiternutzung
		}
